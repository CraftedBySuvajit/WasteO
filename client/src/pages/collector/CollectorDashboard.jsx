            ...
            <section className="page-section active">
              <div className="profile-header">
                ...
                <div className="profile-info">
                  <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--clr-navy)' }}>{profile?.name || user?.name || 'WasteO Collector'}</h3>
        ...
        {isOrderLoading ? (
          ...
          <div className="order-modal-content">
            <div className="print-only receipt-heading">
              <h1 style={{ color: 'var(--clr-green)' }}>WasteO Waste Management</h1>
