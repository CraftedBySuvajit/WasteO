...
export default function AuthPage() {
  ...
  const handleLogin = async (e) => {
    ...
    if (!normalizedEmail || !loginPass || !selectedRole) {
      ...
      <div className="auth-page" id="auth-root">
        ...
        <div className="auth-visual">
          ...
          <div className="auth-visual-brand">
            ...
            <div className="brand-name">WasteO</div>
            <div className="brand-sub">Local Waste Control</div>
          </div>
        ...
        <div className="auth-form-panel">
          <div className="auth-form-box">
            ...
            <div className="auth-tabs" role="tablist" style={{ display: 'flex' }}>
              <button
                ...
                <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '.95rem' }}>
                  <div className="form-group">
                    ...
                    <div className="input-icon-wrap">
                      ...
                      <input className="form-input" type="email" placeholder="Enter your email" value={loginEmail} onChange={(e) => setLoginEmail(e.target.value)} required autoComplete="email" />
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <div className="input-icon-wrap">
                      <span className="input-icon">🔒</span>
                      <input className="form-input" type={showPass ? 'text' : 'password'} placeholder="••••••••" value={loginPass} onChange={(e) => setLoginPass(e.target.value)} required autoComplete="current-password" />
