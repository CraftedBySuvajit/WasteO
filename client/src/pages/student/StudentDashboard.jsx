            ...
            <section className="page-section active" id="sec-profile">
              <div className="profile-header">
                ...
                <div className="profile-info">
                  <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--clr-navy)' }}>{profile?.name || user?.name || 'WasteO User'}</h3>
            ...
            <section className="page-section active" id="sec-store">
              ...
              <div className="store-grid">
                {storeItems.length === 0 ? (
                  ...
                  <div className="store-card" key={item._id} onClick={() => { setSelectedProduct(item); }} style={{ cursor: 'pointer' }}>
          ...
          {receiptOrder && (
            <div className="receipt-container">
              <div className="receipt-header">
                <div className="receipt-logo">♻️ WasteO</div>
